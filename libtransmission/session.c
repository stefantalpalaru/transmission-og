...
void tr_sessionGetDefaultSettings(tr_variant *d)
{
    ...
    tr_variantDictAddBool(d, TR_KEY_scrape_paused_torrents_enabled, false);
...
enum { MINUTES_PER_HOUR = 60, MINUTES_PER_DAY = MINUTES_PER_HOUR * 24, MINUTES_PER_WEEK = MINUTES_PER_DAY * 7 };
